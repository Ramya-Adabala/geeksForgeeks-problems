<h2><a href="https://www.geeksforgeeks.org/problems/maximize-number-of-toys/1">Maximize Number of Toys</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">You are given an integer array <strong>arr[] </strong>that denotes the prices of n different toys. You are also given an amount k that is the total money you have. You need to maximize the number of toys you can have with the k amount.</span></p>
